...
const { Rectangle } = require('../adapters/fabric-adapter');
...
class Material {
   ...
   * @public
   */
  getDuration(withConainer=false) {
    return Math.max(0, (this.getEndOffset(withConainer) - this.getStartOffset()) / this.speed);
  }
