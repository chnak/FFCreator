...
const videoExport = async (options) => {
  ...
  const durationSeconds = await page.evaluate(animationDurationSeconds, options.timeline, options.duration);
  console.log(durationSeconds)
  const duration = await page.evaluate(animationDurationFrames, options.timeline, options.fps, options.duration);
